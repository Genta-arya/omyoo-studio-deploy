              ...
              {showScore ? (
                <div className="text-center">
                  ...
                  <button
                    ...
                    className="bg-black text-white rounded hover:bg-gray-700 focus:outline-none hover:scale-105 hover:z-50 bg-black text-white p-4 rounded-full border-b-8 border-gray-300 shadow-2xl mt-4 animate-pulse"
                  >
